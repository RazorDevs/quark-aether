...
public class DeepAetherVerticalSlabModule extends ZetaModule {
    ...
    public void register(ZRegister register) {
        if(this.enabled && ModList.get().isLoaded(AscendedQuark.DEEP_AETHER)) {
            ...
            new CompAQVerticalSlabBlock("mossy_holystone_tile_vertical_slab", BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS), this);
            new CompAQVerticalSlabBlock("holystone_tile_vertical_slab", BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS), this);
